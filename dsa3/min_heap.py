...
#     for i in range(n-1,0,-1):            #this is same as reverse code. we usually write for i in range(len(lst)-1,-1,-1)
...
#kth LARGEST ELEMENT. ARRANGED IN DESCENDNG ORDER THAN GET K-1

# def heapify_down(lst,i,n):
#     largest=i
#     left=(2*i)+1
#     right=(2*i)+2
